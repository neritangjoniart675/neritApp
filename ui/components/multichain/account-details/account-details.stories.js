...
const { address } = Object.values(testData.neritapp.internalAccounts.accounts)[1];

export default {
  title: 'Components/Multichain/AccountDetails',
  component: AccountDetails,
  argTypes: { address: { control: 'text' } },
  args: { address }
};
...
export const UpgradedAccountStory = (args) => <AccountDetails {...args} address={UPGRADED_ACCOUNT_MOCK} />;
